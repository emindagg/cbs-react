    ...
    return (
        <div className="relative" ref={panelRef}>
            ...
            <button
                ...
                className="h-10 w-10 bg-white rounded-xl shadow-md border border-slate-200/60 flex items-center justify-center text-[#1f2937] hover:bg-slate-50 transition-all focus:outline-none"
