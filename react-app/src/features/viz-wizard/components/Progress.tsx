...
export default function WizardProgress({ currentStep }: WizardProgressProps) {
  return (
    <div className="relative mb-3">
      ...
      {/* Active progress bar */}
      <div
        className="absolute top-2.5 left-0 h-0.5 bg-linear-to-r from-[#2a2a2c] to-[#18181B] transition-all duration-300"
      ...
      <div className="relative flex items-center justify-between">
        {STEPS.map((step) => (
          ...
          step.num === currentStep
            ? 'bg-[#18181B] border-[#18181B] text-white scale-110 shadow-xs'
            : step.num < currentStep
            ...
            <span
              className={`
                ...
                ${step.num === currentStep ? 'text-[#18181B]' : 'text-zinc-400'}
              `}
            >
              {step.label}
            </span>
