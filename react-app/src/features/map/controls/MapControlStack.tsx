      ...
      {!hideControls && (
        <>
          ...
          <button
            ...
            className={`w-9 h-9 bg-[#1c1c1e] rounded-[12px] shadow-[0_2px_8px_rgba(34,34,34,0.35)] border-none flex items-center justify-center text-[#8e8e93] text-sm hover:text-white active:text-white transition-colors cursor-pointer ${isAstronomyEnabled ? 'text-emerald-400 hover:text-emerald-300' : ''}`}
