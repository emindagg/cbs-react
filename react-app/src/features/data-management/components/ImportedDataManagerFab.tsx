    ...
    <>
      ...
      >
        <button
          ...
          className="w-[35px] h-[35px] rounded-full bg-[#18181B] hover:bg-[#2a2a2c] active:bg-[#2c2c2e] border border-slate-700 shadow-lg text-white flex items-center justify-center touch-none select-none"
          ...
          >
            ...
            <div className="max-h-[476px] overflow-y-auto px-3 py-3 space-y-3 bg-white scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-transparent">
              <button
                ...
                className="w-full h-9 rounded-xl bg-[#18181B] hover:bg-[#2a2a2c] active:bg-[#2c2c2e] text-white text-xs font-semibold inline-flex items-center justify-center gap-2 transition-all duration-200 shadow-md hover:shadow-lg active:scale-[0.98]"
              >
              ...
              <div className="space-y-2.5">
                ...
                {themeOpen && (
                  ...
                  >
                    ...
                    <div className="space-y-1.5">
                      <div className="flex items-center justify-between">
                        <label htmlFor="dm-line-width" className="text-xs font-semibold text-slate-800">Çizgi Kalınlığı</label>
                        <input
                          type="number"
                          min={0}
                          max={20}
                          step={0.5}
                          value={layerStyles.lineWidth}
                          onChange={(event) => startTransition(() => updateLayerStyle({ lineWidth: Number(event.target.value), strokeWidth: Number(event.target.value) }))}
                          className="w-14 h-7 border border-slate-300 rounded-lg bg-white text-[11px] text-slate-800 text-center font-medium shadow-sm focus:ring-2 focus:ring-slate-400 focus:border-slate-400"
                        />
                      </div>
                      <input
                        ...
                        className="w-full h-1.5 bg-slate-200 rounded-full appearance-none cursor-pointer accent-slate-900"
                        style={{
                          background: `linear-gradient(to right, #0f172a 0%, #0f172a ${(layerStyles.lineWidth / 20) * 100}%, #e2e8f0 ${(layerStyles.lineWidth / 20) * 100}%, #e2e8f0 100%)`,
                        }}
                      />
                    </div>
              ...
              <div className="space-y-2.5">
                ...
                >
                  <span className="inline-flex items-center gap-2.5">
                    <span className="w-6 h-6 rounded-lg bg-[#18181B] hover:bg-[#2a2a2c] active:bg-[#2c2c2e] text-white inline-flex items-center justify-center shadow-sm">
                      <Settings2 className="w-3.5 h-3.5" />
                    </span>
